...
var SelectVisitor = module.exports = new Class({
    ...
    , _getAndNormalizeNames: function(node){
        ...
        // @note: removed this check to avoid that a field that is named the same as the entity is stripped from the selections
        //if(names.length > 0 && names[0] === this.baseEntity) names.shift();
    ...
    , _reduceSelections: function(selections, level){
        ...
        return {
            ...
            subselects  : currentSubselectMap
        };
    }
